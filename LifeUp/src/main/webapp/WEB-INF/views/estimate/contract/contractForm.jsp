...
<div class="message other alert pinned alert alert-success chrome-extension" style="padding-left: 25px;">
    <div class="message-title" style='height:30px; position:relative;'>
		<div style="float: left;" >
	    	<span class="label label-warning">신규</span><span><b> | </b></span> 
	    	<span class="label label-success">경기도</span><span><b> | </b></span>
	    	<span class="label label-info">아반떼</span>
    	</div>
    	<div style="float: right;">
    		<span class="label">2014. 02. 12   작성자</span>
    	</div>		    	
    </div>
