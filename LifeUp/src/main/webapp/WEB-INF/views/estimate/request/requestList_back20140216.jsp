    		...
    		function (data) {
				if (data.list != "") {
					...
					$.each(data.list, function(idx, row) {
						$contents.append("<div id='contents' class='message other alert pinned alert alert-success chrome-extension'>");
						$contents.append("<p class='message-title'><span class='text'>" + row.REGION_NM + " > "+  row.CAR_NM+">"+ row.CREATE_DATE +"</span></p><hr class='message-inner-separator'><div class='info-inner'>"+row.CUSTOMER_REQ +":"+row.CUSTOMER_ID +"</div>");
						//$contents.append(+ row.REGION_NM + " > "+  row.CAR_NM+">"+ row.CREATE_DATE +"</span></p><hr class='message-inner-separator'><div class='info-inner'>"+row.CUSTOMER_REQ +":"+row.CUSTOMER_ID +"</div>");
						//$(".messages").append("<div id='contents' class='message other alert pinned alert alert-success chrome-extension'><p class='message-title'><span class='text'>"+row.REGION_NM + " > "+  row.CAR_NM+">"+ row.CREATE_DATE +"</span></p><hr class='message-inner-separator'><div class='info-inner'>"+row.CUSTOMER_REQ +":"+row.CUSTOMER_ID +"</div>");						
 						//$(".messages").append("</div>");
